...
THREE.GLTFLoader = ( function () {
	...
	GLTFParser.prototype.loadBufferView = function ( bufferViewIndex ) {
		...
		var bufferViewPending = this._on( 'BufferView', bufferViewDef );

		if ( !bufferViewPending ) {

			bufferViewPending = this.getDependency( 'buffer', bufferViewDef.buffer ).then( function ( buffer ) {
