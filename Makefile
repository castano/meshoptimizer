...
WASM_EXPORTS=["_meshopt_decodeVertexBuffer","_meshopt_decodeIndexBuffer","_meshopt_decodeFilterReconstructZ","_meshopt_decodeFilterReconstructW","_meshopt_decodeFilterReconstructQ","_sbrk","__start"]
